...
pub fn target() -> Target {
    Target {
        ...
        options: TargetOptions {
            abi: cow!("abiv2"),
            features: cow!(
                "+2e3,+3e7,+7e10,+cache,+dsp1e2,+dspe60,+e1,+e2,+edsp,+elrw,+hard-tp,+high-registers,+hwdiv,+mp,+mp1e2,+nvic,+trust"
            ),
            late_link_args: LazyLock::new(|| {
                TargetOptions::link_args(LinkerFlavor::Gnu(Cc::Yes, Lld::No), &["-l:libatomic.a"])
            }),
